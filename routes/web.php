...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/lipstick', [LipstickController::class, 'index']);
    Route::get('/edit/{lipstick}', [LipstickController::class, 'edit']);
    Route::get('/delete/{lipstick}', [LipstickController::class, 'destroy']);
